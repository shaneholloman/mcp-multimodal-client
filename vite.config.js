    ...
    return {
        ...
        configureServer: function (server) {
            ...
            server.middlewares.use(function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var chunks, chunk, e_1_1, data, config, error_1;
                var _a, req_1, req_1_1;
                var _b, e_1, _c, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            if (!(req.method === "POST" && req.url === "/api/config/agent")) return [3 /*break*/, 17];
                            _e.label = 1;
                        case 1:
                        ...
                        case 13:
                            ...
                            return [4 /*yield*/, fs.writeFile(path.resolve(__dirname, "config/agent.config.json"), JSON.stringify(config, null, 2))];
                        case 14:
                            _e.sent();
                            res.statusCode = 200;
                        ...
                        case 15:
                            error_1 = _e.sent();
                            console.error("Error writing config:", error_1);
                            res.statusCode = 500;
                            res.end(JSON.stringify({ error: error_1.message }));
                            return [3 /*break*/, 16];
